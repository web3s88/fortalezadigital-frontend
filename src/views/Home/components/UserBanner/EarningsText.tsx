...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and Duro pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and Duro pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from Duro pool', data)
  }
