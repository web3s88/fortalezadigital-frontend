  ...
  return [
    {
      ...
      bodyText: [t('You’ll need an active FortalezaDuro Profile to buy Minting Tickets and mint a Pancake Squad NFT!')],
      buttons: (
        <>
    ...
    },
    {
      ...
      title: t('Hold Duro'),
      bodyText: [t('Each NFT costs Duro to mint. Remember you also need BNB to cover transaction fees too!')],
      buttons: (
        <>
          <Button
            as="a"
